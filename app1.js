document.addEventListener('DOMContentLoaded', function () {
  ...
  const photos = document.querySelectorAll(".websites");
  let currentSlide = 0;
  ...
  document.querySelector("#initial-greeting").innerHTML = initialGreeting;
  document.querySelector("#final-greeting").innerHTML = finalGreeting;

  //Progress circle with my apps number
